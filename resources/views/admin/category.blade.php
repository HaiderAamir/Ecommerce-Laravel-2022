...
{{-- new modal --}}
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="backDropModalTitle">New Cetagory</h5>
    ...
    <button type="button" class="float-end ms-2 btn rounded-pill btn-icon btn-primary waves-effect waves-light"
        ...
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Category Table</h4>
                ...
                <table class="datatables-basic table" id="myTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td id="p_id">{{$data->id}}</td>
                            <td id="p_name">{{$data->name}}</td>
                            <td id="p_cat">{{$data->created_at}}</td>
                            <td>
                                <form action="/admin/delete_category" method="POST">
                                    @csrf
                                    <input type="text" name="data_id" id="" value="{{$data->id}}" hidden>
                                    <button type="submit"
