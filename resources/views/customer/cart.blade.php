                                    ...
                                    <tbody>
                                        ...
                                        <tr class="table-head">
                                            <td class="image product-thumbnail">
                                                <a href="#"><img src="{{ asset('../../products/' . $cart_data->product->pic1 . '.png') }}" class="img-fluid" alt=""></a>
                                            </td>
                                            <td><a href="#">{{$cart_data->product_name}}</a></td>
                                            <td class="text-center detail-info" data-title="Stock">
                                                <div class="detail-extralink mr-15">
                                                    <div class="detail-qty border radius">
                                                        <input type="text" name="" id="qty_pre" value="{{$cart_data->product_qty}}" hidden>
                                                        {{-- <span id="qty_new"></span> --}}
                                                        <a href="#" class="qty-down decrease-qty" id="p_down" data-id="{{ $cart_data->product_id }}" data-session="{{  Session::getId() }}"><i class="fi-rs-angle-small-down"></i></a>
                                                        <span class="qty-val qty_new" id="">{{$cart_data->product_qty}}</span>
                                                        <a href="#" class="qty-up increase-qty" id="p_up" data-id="{{ $cart_data->product_id }}" data-session="{{  Session::getId() }}"><i class="fi-rs-angle-small-up"></i></a>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                @if($cart_data->product->sale_active == 1)
                                                {{ number_format(100 - ($cart_data->product->sale_price / $cart_data->product->price) * 100, 0) }}
                                                @elseif ($cart_data->product->sale_active == 0)
                                                0
                                                @endif
                                                %
                                            </td>
                                            <td>Rs.
                                                @if($cart_data->product->sale_active == 1)
                                                <span class="total_price">{{ $cart_data->product->sale_price }}</span>
                                                @elseif ($cart_data->product->sale_active == 0)
                                                <span class="total_price">{{ $cart_data->product->price }}</span>
                                                @endif
                                            </td>
                                            <td>Rs.<span class="total_show">{{$cart_data->product_qty * $cart_data->product_price}}</span></td>
                                            <td><a href="/remove_cart/{{$cart_data->id}}" class="table-btn-close"><i class="feather-x-circle"></i></a></td>
                                        </tr>
                            ...
                            <div class="row">
                                <div class="col-lg-8 col-md-6">
                                    <div class="shop-cart-action">
                                        <a href="/shop" class="btn continue-btn">Continue Shopping</a>
                                        <a href="/empty_basket" class="btn basket-btn">Empty Basket</a>
                                    </div>
                                </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="shop-cart-info">
                                                <p>Total Price <span class="check_data1"></span><span>Rs.&nbsp;</span></p>
                                                <p>Delivery Charges <span>Rs 0.00</span></p>
                                                <p>Total Price <span class="check_data1"></span><span>Rs.&nbsp;</span></p>
                                                @if (!session()->has('name') || !session()->has('email') || !session()->has('customer_id'))
                                                    <a class="btn checkout-btn w-100"  data-bs-toggle="modal" data-bs-target="#quickViewModal">Go To Checkout</a>
                                                @else
                                                    <a href="/cart/address" class="btn checkout-btn w-100">Go To Checkout</a>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
