                                ...
                                <form action="/otp" method="POST">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            <input type="text" required placeholder="First Name" name="f_name" value="{{old('f_name')}}">
                                            @if ($errors->has('f_name'))
                                                <span class="error">{{ $errors->first('f_name') }}</span>
                                            @endif
                                        </div>
                                        <div class="form-group col-md-6">
                                            <input type="text" required placeholder="Last Name" name="l_name" value="{{old('l_name')}}">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            <input required="" required type="password" placeholder="Password" name="pass" value="{{old('pass')}}">
                                            @if ($errors->has('pass'))
                                                <span class="error">{{ $errors->first('pass') }}</span>
                                            @endif
                                        </div>
                                        <div class="form-group col-md-6">
                                            <input required="" required type="password" placeholder="Confirm password" name="c_pass" value="{{old('c_pass')}}">
                                            @if ($errors->has('c_pass'))
                                                <span class="error">{{ $errors->first('c_pass') }}</span>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" required placeholder="Enter  Address" name="address" value="{{old('address')}}">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            <input type="text" required placeholder="Enter City" name="city" value="{{old('city')}}">
                                            @if ($errors->has('city'))
                                                <span class="error">{{ $errors->first('city') }}</span>
                                            @endif
                                        </div>
                                        <div class="form-group col-md-6">
                                            <input type="text" required placeholder="Enter Postcde" name="postcode" value="{{old('postcode')}}">
                                    ...
                                    <div class="form-group">
                                        <input type="text" required placeholder="Enter Phone" name="phone" value="{{old('phone')}}">
                                        @if ($errors->has('phone'))
									...
									<div class="form-group">
                                        <button id="submit_button" type="submit" class="btn btn-brand" disabled>Create Account</button>
                                    </div>
