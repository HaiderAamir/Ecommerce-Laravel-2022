                                                ...
                                                <div class="card mb-25">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="card-details">
                                                            <h4 class="card-details-title">{{ $user->f_name }} {{ $user->l_name }}</h4>
                                                            <p><i class="feather-phone"></i> {{ $user->phone }}</p>
                                                            <p class="d-flex"><i class="feather-map-pin"></i> {{ $user->address1 }}, {{ $user->country }}</p>
                                                            <a href="#" aria-label="editmodal"data-bs-toggle="modal" data-bs-target="#editmodal">Edit</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="/update_personal_details" method="post">
                            @csrf
                            <input type="text" name="email" id="" value="{{ $user->email }}" hidden>
                            <div class="input-style mb-15">
                                <input name="address" type="text" class="form-control" placeholder="Address 1" value="{{ $user->address1 }}">
                            </div>
                            <div class="input-style mb-15">
                                <input name="city" type="text" class="form-control" placeholder="City" value="{{ $user->city }}">
                            </div>
                            <div class="input-style mb-15">
                                <input name="postcode" type="text" class="form-control" placeholder="Postal Code" value="{{ $user->postcode }}">
                            </div>
                            ...
                            <div class="input-style mb-20">
                                <input name="phone" type="text" class="form-control" placeholder="Phone Number" value="{{ $user->phone }}">
                            </div>
